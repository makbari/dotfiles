...
bindsym $mod+Shift+i exec scrot ~/Pictures/screenshot_%Y-%m-%d-%H:%M:%S.png

# Selective region screenshot
bindsym $mod+Shift+o exec --no-startup-id urxvt -e scrot -s ~/Pictures/screenshot_%Y-%m-%d-%H-%M-%S.png
